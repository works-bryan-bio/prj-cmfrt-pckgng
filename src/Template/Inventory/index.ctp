 ...
 <div class="ribbon-section">
      <div class="ribbon-black" style="padding-top:0px !important;">
          <ul class="nav nav-tabs nav-justified">
            ...
            <li><a href="#pending_orders" class="ribbon-li" data-toggle="tab">View Pending Orders</a></li>
      ...
      <div class="tab-pane" id="completed">
        <div class="table-responsive data-content">    
            <table class="zero-config-datatable-5-desc display">
                ...
                <tbody>
                    <?php foreach ($inventoryCompletedOrders as $inventoryCompletedOrders):
                          $inventory_info = array();
                          $inventory_info = $this->Inventory->find('all')->where(['Inventory.shipment_id' => $inventoryCompletedOrders->shipment->id])->first();
                    ...
                    <tr>
                      ...
                      <td style="text-align:center;"><?= $inventoryCompletedOrders->order_number ?></td>
                      <td><?= $inventoryCompletedOrders->client->firstname ." ". $inventoryCompletedOrders->client->lastname ?></td>
                      <td><?= $inventoryCompletedOrders->shipment_id ." - ". $inventoryCompletedOrders->shipment->item_description ?></td>
                      <td><?= $inventoryCompletedOrders->order_destination ?></td>
                      <td><?= h($inventoryCompletedOrders->date_created) ?></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
