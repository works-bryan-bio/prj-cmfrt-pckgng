            ...
            <table class="zero-config-datatable display">
                ...
                <tbody>
                    ...
                    <tr>
                          ...
                          <td class="actions no-border-right" style="width:20% !important;text-align:center;">
            ...
            <table class="zero-config-datatable display">
                ...
                <tbody>
                    ...
                    <tr>
                                ...
                                <td class="actions">
                            <?= $this->Html->link('<i class="fa fa-eye"></i> ' . __('View'), ['controller' => 'inventory_order', 'action' => 'index', $inventory_completed->shipment->id, $inventory_completed->id],['title' => 'View', 'class' => 'btn btn-sm btn-info', 'escape' => false]) ?>
                           
                            <!-- Delete Modal -->
                            <div id="modal-<?=$inventory_completed->id?>" class="modal fade">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <div class="modal-header">
                                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                  ...
                                  <div class="modal-footer">
                                      ...
                                      <?= $this->Form->postLink(
                                              'Yes',
                                              ['action' => 'delete', $inventory_completed->id],
                                              ['class' => 'btn btn-danger', 'escape' => false]
                                          )
                                      ?>
                                  </div>
