                ...
                <fieldset>        
                    <?php                            
                        ...
                        <div class='form-group'>
                            <label for='item_description' class='col-sm-2 control-label'>" . __('Item Description') . "</label> <i class='fa fa-info' data-toggle='tooltip' data-placement='right' title='Input the Item Description' ></i>
                            <div class='col-sm-6'>";
                        ...
                        echo " </div></div>";    
                                  ...
                                  echo "
                        <div class='form-group'>
                            <label for='additional_information' class='col-sm-2 control-label'>" . __('Additional Information') . "</label> <i class='fa fa-info' data-toggle='tooltip' data-placement='right' title='Input the Addition Information ' ></i>
                            <div class='col-sm-6'>";
                        ...
                        echo " </div></div>";  
                                    ...
                                    echo "
                        <div class='form-group'>
                            <label for='quantity' class='col-sm-2 control-label'>" . __('Quantity') . "</label> <i class='fa fa-info' data-toggle='tooltip' data-placement='right' title='Input the quantity of the items' ></i>
                            <div class='col-sm-6'>";
                        ...
                        echo " </div></div>";    
                                    ...
                                    echo "
                        <div class='form-group'>
                            <label for='boxes' class='col-sm-2 control-label'>" . __('Boxes') . "</label> <i class='fa fa-info' data-toggle='tooltip' data-placement='right' title='Input the quantity of boxes included' ></i>
                            <div class='col-sm-6'>";
                            echo $this->Form->input('boxes', ['type' => 'text', 'class' => 'form-control', 'id' => 'boxes', 'label' => false]);                
                        echo " </div></div>";    
                                   echo "
                        <div class='form-group'>
                            <label for='boxes' class='col-sm-2 control-label'>" . __('Supplier') . "</label> <i class='fa fa-info' data-toggle='tooltip' data-placement='right' title='Input the supplier name' ></i>
                            <div class='col-sm-6'>";
                        ...
                        echo " </div></div>";
                         ...
                         echo "
                        <div class='form-group'>
                            <label for='upload_label' class='col-sm-2 control-label'>" . __('Upload label') . "</label> <i class='fa fa-info' data-toggle='tooltip' data-placement='right' title='Upload label' ></i>
                            <div class='col-sm-6'>";
                        ...
                        echo " </div></div>";
                                    ...
                                    echo "
                        <div class='form-group'>
                            <label for='shipping_carrier_id' class='col-sm-2 control-label'>" . __('Shipping Carrier') . "</label> <i class='fa fa-info' data-toggle='tooltip' data-placement='right' title='Select Shipping Carrier on the list' ></i>
                            <div class='col-sm-6'>";
                        ...
                        <div class='form-group hidden other-shipping-carrier'>
                            <label for='other_shipping_carrier' class='col-sm-2 control-label'>" . __('Other Shipping Carrier') . "</label> <i class='fa fa-info' data-toggle='tooltip' data-placement='right' title='Select Other Shipping Carrier on the list' ></i>
                            <div class='col-sm-6'>";
                        ...
                        echo " </div></div>";    
                                    ...
                                    echo "
                        <div class='form-group'>
                            <label for='shipping_service_id' class='col-sm-2 control-label'>" . __('Shipping Service') . "</label> <i class='fa fa-info' data-toggle='tooltip' data-placement='right' title='Select Shipping Service on the list' ></i>
                            <div class='col-sm-6'>";
                        ...
                        <div class='form-group hidden other-shipping-service'>
                            <label for='other_shipping_service' class='col-sm-2 control-label'>" . __('Other Shipping Service') . "</label> <i class='fa fa-info' data-toggle='tooltip' data-placement='right' title='Select Other Shipping Service on the list' ></i>
                            <div class='col-sm-6'>";
                            echo $this->Form->input('other_shipping_service', ['class' => 'form-control', 'id' => 'other_shipping_service', 'label' => false]);                
                        echo " </div></div>";    
                        echo "
                        <div class='form-group'> 
                            <label for='shipping_purpose_id' class='col-sm-2 control-label'>" . __('Shipping Purpose') . "    </label> <i class='fa fa-info' data-toggle='tooltip' data-placement='right' title='Select Shipping purpose on the list' ></i>
                            <div class='col-sm-6'> ";
                        ...
                        <div class='form-group send-amazon-only-group hidden'>
                            <label for='send_amazon_qty' class='col-sm-2 control-label'>" . __('add FNSKU labels') . "</label> <i class='fa fa-info' data-toggle='tooltip' data-placement='right' title='Upload FNSKU labels' ></i>
                            <div class='col-sm-6'>";
                        ...
                        <div class='form-group send-amazon-group hidden'>
                            <label for='send_amazon_qty' class='col-sm-2 control-label'>" . __('How many?') . "</label> <i class='fa fa-info' data-toggle='tooltip' data-placement='right' title='Input the Quantity of items you want to send to amazon' ></i>
                            <div class='col-sm-6'>";
                        ...
                        <div class='form-group combine-with-group hidden'>
                            <label for='combine_with_id' class='col-sm-2 control-label'>" . __('Client Pending Shipments') . "</label> <i class='fa fa-info' data-toggle='tooltip' data-placement='right' title='Select Pending Shipments on the list' ></i>
                            <div class='col-sm-6'>";
                        ...
                        echo "
                        <div class='form-group combine-with-group hidden'>
                            <label for='combine_comment' class='col-sm-2 control-label'>" . __('Remarks') . "</label> <i class='fa fa-info' data-toggle='tooltip' data-placement='right' title='Input the remarks' ></i>
                            <div class='col-sm-6'>";
                        ...
                        echo "
                        <div class='form-group'>
                            <label for='comments' class='col-sm-2 control-label'>" . __('Shipping Instruction') . "</label> <i class='fa fa-info' data-toggle='tooltip' data-placement='right' title='Check the shipping instruction' ></i>
                            <div class='col-sm-6'>";
                        ...
                        echo "
                        <div class='form-group'>
                            <label for='comments' class='col-sm-2 control-label'>" . __('Comments') . "</label> <i class='fa fa-info' data-toggle='tooltip' data-placement='right' title='Input the comments' ></i>
                            <div class='col-sm-6'>";
