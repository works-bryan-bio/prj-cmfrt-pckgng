...
?>
<p>Hi,</p> 
<p>Your shipment has been <b>received</b>. See shipment details below.</p>
<br>
<table border="0">
	<tr>
	...
	<tr>
		<th style="background-color: #cccccc; color: #ffffff; padding: 15px;" align="center">Remaining Quantity</th>
		<td>
