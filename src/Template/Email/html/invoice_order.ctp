  ...
  <div style="width: 100%;">
		...
		<div style="border: 1px solid #232225; padding: 24px;">	
			...
			<table style="width: 90%;border-right: solid 1px #232225;border-left: solid 1px #232225;border-bottom: solid 1px #232225;">
				...
				<?php }else { ?>
					<tr>
						<th style="text-transform:uppercase;background-color: #232225; color: #ffffff; padding: 15px;" align="center">Shipment</th>
						<td style="padding-left: 10px;text-transform:uppercase"><?= $shipment_details->item_description; ?></td>
					</tr>	
					<tr>
