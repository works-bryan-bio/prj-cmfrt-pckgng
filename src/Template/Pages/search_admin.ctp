                ...
                <div class="col-sm-6">
                    ...
                    <?php foreach ($shipments as $shipment) { ?>
                        <li>
                            ...
                            <a href="<?php echo $this->Url->build("/shipments/client_view/" . $shipment->id);  ?>" class="btn btn-primary read-more-btn">Read more</a>                            
                         </li>   
                      <?php  }?>

                      <?php foreach ($inventory_order as $order) { ?>
                        <li>
                         <h2 class="title"><?php echo $order->order_number . " - " . $order->shipment->item_description ; ?> </h2>
