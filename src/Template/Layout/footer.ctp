<?php use Cake\Utility\Inflector; ?>
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-6 left">
                  <ul class="footer-ul left" style="margin-left: 0px !important;">
                    ...
                    <li>Social Media Management</li>
                    <li>Search Engine Optimazation</li>
                    <li><a href="<?= $base_url; ?>login">Client Portal</a></li>
                  </ul>
                </div>
              </div>
            </div>            
    ...
    if ($(window).width() < 760) {
      ...
      $("div.about-nav").mouseleave(function() {
      ...
      $("div.service-nav").mouseleave(function() {
      ...
      $("div.project-nav").mouseleave(function() {
      ...
      $("div.contact-nav").mouseleave(function() {
      ...
      $("div.contact-nav").click(function() {
          ...
          $("div.service-nav").removeClass("orange");
      ...
      $("div.service-nav").click(function() {
          ...
          $("div.service-nav").addClass("orange");
      ...
      $(".scroll-to-aboutus").click(function(){
        $('html, body').animate({
            scrollTop: $("#about-container").offset().top - 150
        }, 1500);
      });

      $(".scroll-to-service").click(function(){
        $('html, body').animate({
            scrollTop: $("#services-container").offset().top - 150
        }, 1500);
      });

      $(".scroll-to-projects").click(function(){
        $('html, body').animate({
            scrollTop: $("#project-container").offset().top - 150
        }, 1500);
      });

      $(".scroll-to-contactus").click(function(){
        $('html, body').animate({
            scrollTop: $("#contact-container").offset().top - 150
        }, 1500);
      });
      ...
      $(document).scroll(function() {
        ...
        if (y > 1300) {
          $(".fix-bar").removeClass("hide-nav");
        } else {
          $(".fix-bar").addClass("hide-nav");
        }
      });
