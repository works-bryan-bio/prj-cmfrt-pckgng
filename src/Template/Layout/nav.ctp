...
<nav class="navbar navbar-default nav-collapse" style="display:none;margin-bottom: 0px;" role="navigation">
   ...
   <div class="collapse navbar-collapse" id = "example-navbar-collapse">
      <ul class="nav navbar-nav">
         <li class="active"><a href="javascript:void(0);" class="scroll-to-aboutus">About Us</a></li>
         <li><a href="javascript:void(0);" class="scroll-to-service">Services</a></li>
         <li><a href="javascript:void(0);" class="scroll-to-projects">Our Project</a></li>
         <li><a href="javascript:void(0);" class="scroll-to-contactus">Contact Us</a></li>
         <!-- dropdown layout
         <li class="dropdown">
...
<nav class="fix-bar hide-nav">
  ...
  <div class="row nav-desktop-space" style="background-color:#f1f2f4;height:10px;"></div>
  <div class="row nav-desktop-text" style="background-color:#f1f2f4;">
    <div class="container twoside">
      <div class="col-md-12">
         <div class="col-md-2 center about-nav padding-nav">
            <a class="link-nav link-about scroll-to-aboutus" href="javascript:void(0);">ABOUT US</a>
          </div>
          <div class="col-md-2 service-nav center padding-nav">
            <a class="link-nav link-service scroll-to-service" href="javascript:void(0);">SERVICES</a>
          </div>
          <div class="col-md-4 padding-nav"></div>
          <div class="col-md-2 project-nav center padding-nav">
            <a class="link-nav link-project scroll-to-projects" href="javascript:void(0);">OUR PROJECTS</a>
          </div>
          <div class="col-md-2 contact-nav center padding-nav">
           <a class="link-nav link-contact scroll-to-contactus" href="javascript:void(0);">CONTACT US</a>
          </div>
      </div>
    </div>
  </div>
