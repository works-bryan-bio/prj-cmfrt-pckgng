<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><?= __('Edit Group') ?></h1>
        <ol class="breadcrumb">
            <li>
                ...
                <div class="form-group" style="margin-top: 80px;">
                    <div class="col-sm-offset-2 col-sm-10">
                        <div class="action-fixed-bottom">
                            ...
                            <?= $this->Form->button('<i class="fa fa-edit"></i> ' . __('Save and Continue editing'),['name' => 'edit', 'value' => 'edit', 'class' => 'btn btn-info', 'escape' => false]) ?>
