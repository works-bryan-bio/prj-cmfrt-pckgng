<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><?= __('Edit Invoice') ?></h1>
        <ol class="breadcrumb">
            <li>
                ...
                <fieldset>        
                    <?php
                        ...
                        <div class='form-group'>
                            <label for='shipments_id' class='col-sm-2 control-label'>" . __('Shipments Id') . "</label>
                            <div class='col-sm-6'>";
                             echo $this->Form->input('shipments_id', ['class' => 'form-control', 'id' => 'shipments_id', 'label' => false, 'options' => $shipments]);                 
                        echo " </div></div>";    
                                    echo "
                        <div class='form-group'>
                            <label for='clients_id' class='col-sm-2 control-label'>" . __('Clients Id') . "</label>
                            <div class='col-sm-6'>";
                             echo $this->Form->input('clients_id', ['class' => 'form-control', 'id' => 'clients_id', 'label' => false, 'options' => $clients]);                 
                        echo " </div></div>";    
                                    echo "
                        <div class='form-group'>
                        ...
                        <div class='form-group'>
                            ...
                            <div class='col-sm-6'>";
                            echo $this->Form->input('invoice_date', ['class' => 'form-control', 'id' => 'invoice_date', 'label' => false]);                
                        echo " </div></div>";    
                        ...
                        <div class='form-group'>
                            ...
                            <div class='col-sm-6'>";
                            echo $this->Form->input('due_date', ['class' => 'form-control', 'id' => 'due_date', 'label' => false]);                
                        echo " </div></div>";    
