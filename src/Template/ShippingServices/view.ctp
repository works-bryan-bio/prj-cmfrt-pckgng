<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><?= __('View Shipping Service') ?></h1>
        <ol class="breadcrumb">
            <li>
                <i class="fa fa-dashboard"></i> <?= __('Shipping Services') ?>
            </li>
            <li class="active">
...
<section class="content">   
    ...
    <div class="related">
        ...
        <?php if (!empty($shippingService->shipments)): ?>
        <table class="table table-striped table-bordered table-hover">
            <tbody>
            <tr>
                <th><?= __('Id') ?></th>
            ...
            <?php foreach ($shippingService->shipments as $shipments): ?>
            <tr>
