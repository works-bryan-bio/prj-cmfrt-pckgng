...
/**
 * InvoiceDetailsFixture
 *
 */
class InvoiceDetailsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'product_service' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'amount' => ['type' => 'float', 'length' => 11, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
    ...
    public $records = [
        [
            'id' => 1,
            'invoice_id' => 1,
            'product_service' => 'Lorem ipsum dolor sit amet',
            'description' => 'Lorem ipsum dolor sit amet',
            'quantity' => 1,
            'rate' => 1,
            'amount' => 1,
            'date_created' => '2017-01-04 17:28:15'
        ],
    ];
}
